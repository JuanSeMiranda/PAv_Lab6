#OBJS Contenedor donde se van a escribir por unica vez todos los archivos objeto
OBJS = main.o Perfil.o Estudiante.o Docente.o DtTimeStamp.o DtFecha.o DtLog.o \
	   ...
	   DtIniciarMonitoreo.o CEliminarAsignatura.o CInscripcionAsignatura.o\
	   DtParticipacion.o CEnvioDeMensaje.o DtInfoClase.o DtInfoTeorico.o \
	   DtInfoMonitoreo.o CListadoClases.o 
...
%.o: %.cpp
	g++ -g -c -MD $<
# Se usa $< para el .cpp (o segundo atb) y $@ para .o (o primer atributo)
